...
public class DataOKHttp {
    private final static Log log = LogFactory.getLog(DataOKHttp.class);
    // 网络请求的路径
    ...
    private String loggerTag = DataOKHttp.class.getSimpleName();
    // 成功的响应码
...
//	private String respCharsetName = null;
    ...
    /**
     * 使用自定义OkHttpClient构造DataOKHttp
     *
     * @param okHttpClient 自定义的OkHttpClient，若是NULL使用默认OkHttpClient
     */
    public DataOKHttp(OkHttpClient okHttpClient) {
        super();
        this.Url = null;
        this.isPost = true;
     ...
     * @return
     */
    public DataOKHttp setResponseParse(ResponseParseData responseParse) {
     ...
     * @return
     */
    public DataOKHttp setAjax(boolean isAjax) {
        this.isAjax = isAjax;
        return this;
    }
     ...
     */
    public DataOKHttp setParseFormat(String parseFormat) {
     ...
     * @return
     */
    public DataOKHttp setCookieInterface(HttpCookieInterface cookieInterface) {
     ...
     * @return
     */
    public DataOKHttp setCookieTag(String cookieTag) {
     ...
     * @return
     */
    public DataOKHttp setHttpCacheInterface(HttpCacheInterface httpCacheInterface) {
     ...
     * @return
     */
    public DataOKHttp setCacheTag(String cacheTag) {
     ...
     * @return
     */
    public DataOKHttp setForceMainLooper(boolean isForceMainLooper) {
     ...
     * @return
     */
    public DataOKHttp setReqeustHeaders(Map<String, String> reqeustHeaders) {
     ...
     * @return
     */
    public DataOKHttp setLogger(String loggerTag) {
     ...
     * @return
     */
    public DataOKHttp setLogger(HttpConfig.LoggerLevel loggerLevel) {
     ...
     * @return
     */
    public DataOKHttp setLogger(HttpConfig.LoggerLevel loggerLevel, String loggerTag) {
        if (null == loggerLevel) {
     ...
     * @return
     */
    public DataOKHttp setTryCallBack(boolean isTryCallBack) {
     ...
     * @return
     */
    public DataOKHttp setRequestBody(String postStr) {
        if (null == postStr) {
            return this;
        }
     ...
     * @return
     */
    public DataOKHttp setRequestBodyByCharset(String postStr, String bodyCharsetName) {
        if (null == postStr) {
            return this;
        }
     ...
     * @return
     */
    public DataOKHttp setRequestBodyByContentType(String postStr, String contentType) {
        if (null == postStr) {
            return this;
        }
     ...
     * @return
     */
    public DataOKHttp setRequestBody(HttpMultipartBuilder httpMultipartBuilder) {
