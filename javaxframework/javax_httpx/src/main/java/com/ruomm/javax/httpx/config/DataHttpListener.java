...
public interface DataHttpListener {
     ...
     */
    public void httpCallBack(Object resultObj, byte[] resultData, Map<String, String> resultHeaders, int status);
     ...
     */
    public boolean httpCallBackFilter(byte[] resultData, Map<String, String> resultHeaders, int status);
