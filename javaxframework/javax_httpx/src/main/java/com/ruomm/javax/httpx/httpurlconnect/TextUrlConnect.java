...
public class TextUrlConnect {
    private final static Log log = LogFactory.getLog(TextUrlConnect.class);
    // 网络请求的路径
...
//	private Call mCall = null;
    ...
    private String loggerTag = TextUrlConnect.class.getSimpleName();
    // 成功的响应码
...
//	private String respCharsetName = null;
    ...
    /**
     * 使用默认UrlConnectClient构造TextHttpClient
     *
     * @return
     */
    public TextUrlConnect() {
        this(null);
    }

    /**
     * 使用自定义UrlConnectClient构造TextUrlConnect
     *
     * @param urlConnectClient 自定义的UrlConnectClient，若是NULL使用默认UrlConnectClient
     */
    public TextUrlConnect(UrlConnectClient urlConnectClient) {
        super();
        this.Url = null;
        this.keepAlive = true;
        this.isPost = true;
    ...
    public TextUrlConnect setUrl(String url) {
        this.Url = url;
     ...
     * @return
     */
    public TextUrlConnect setResponseParse(ResponseParseText responseParse) {
     ...
     * 自定义超时时间
     *
     * @param connetionTimeOut 连接超时毫秒时间
     * @param readTimeout      读取超时毫秒时间
     * @return
     */
    public TextUrlConnect setTimeOut(int connetionTimeOut, int readTimeout) {
     ...
     * @return
     */
    public TextUrlConnect setPost(boolean isPost) {
        this.isPost = isPost;
        return this;
    }
     ...
     * @return
     */
    public TextUrlConnect setKeepAlive(boolean keepAlive) {
     ...
     * @return
     */
    public TextUrlConnect setAjax(boolean isAjax) {
        this.isAjax = isAjax;
        return this;
    }
     ...
     * @return
     */
    public TextUrlConnect setCharset(String charsetName) {
     ...
     */
    public TextUrlConnect setParseFormat(String parseFormat) {
     ...
     * @return
     */
    public TextUrlConnect setCookieInterface(HttpCookieInterface cookieInterface) {
     ...
     * @return
     */
    public TextUrlConnect setCookieTag(String cookieTag) {
     ...
     * @return
     */
    public TextUrlConnect setHttpCacheInterface(HttpCacheInterface httpCacheInterface) {
     ...
     * @return
     */
    public TextUrlConnect setCacheTag(String cacheTag) {
     ...
     * @return
     */
    public TextUrlConnect setForceMainLooper(boolean isForceMainLooper) {
     ...
     * @return
     */
    public TextUrlConnect setReqeustHeaders(Map<String, String> reqeustHeaders) {
     ...
     * @return
     */
    public TextUrlConnect setLogger(String loggerTag) {
     ...
     * @return
     */
    public TextUrlConnect setLogger(HttpConfig.LoggerLevel loggerLevel) {
     ...
     * @return
     */
    public TextUrlConnect setLogger(HttpConfig.LoggerLevel loggerLevel, String loggerTag) {
        if (null == loggerLevel) {
     ...
     * @return
     */
    public TextUrlConnect setTryCallBack(boolean isTryCallBack) {
...
//		}
     ...
     * @return
     */
    public TextUrlConnect setRequestBody(UrlRequestEntry mUrlRequestEntry) {
     ...
     * @return
     */
    public TextUrlConnect setRequestBody(String postStr) {
        if (null == postStr) {
            return this;
        }
     ...
     * @return
     */
    public TextUrlConnect setRequestBodyByCharset(String postStr, String bodyCharsetName) {
        if (null == postStr) {
            return this;
        }
     ...
     * @return
     */
    public TextUrlConnect setRequestBodyByContentType(String postStr, String contentType) {
        if (null == postStr) {
            return this;
        }
     ...
     * @return
     */
    public TextUrlConnect setRequestBody(HttpMultipartBuilder httpMultipartBuilder) {
        ...
        if (!HttpConfig.isSuccessful(responseCode)) {
            ...
            try {
                ...
                if (null == charsetName || charsetName.length() <= 0) {
                    responseData = new String(resultBytes, Charset.forName("UTF-8"));
                } else {
                    responseData = new String(resultBytes, Charset.forName(charsetName));
                }
            } catch (Exception e) {
                log.error("Error:parseResponse", e);
                responseData = null;
            ...
            String responseData = null;
            try {
                byte[] resultBytes = UtilHttp.readInputStream(conn.getInputStream());
                if (null == charsetName || charsetName.length() <= 0) {
                    responseData = new String(resultBytes, Charset.forName("UTF-8"));
                } else {
                    responseData = new String(resultBytes, Charset.forName(charsetName));
