...
public class DataHttpClient {
    private final static Log log = LogFactory.getLog(DataHttpClient.class);
    // 网络请求的路径
...
//	private Call mCall = null;
    ...
    private String loggerTag = DataHttpClient.class.getSimpleName();
    // 成功的响应码
...
//	private String respCharsetName = null;
    ...
    /**
     * 使用默认HttpClient构造DataHttpClient
     *
     * @return
     */
    ...
    /**
     * 使用自定义HttpClient构造DataHttpClient
     *
     * @param mHttpClient 自定义的HttpClient，若是NULL使用默认HttpClient
     */
    public DataHttpClient(HttpClient mHttpClient) {
        super();
        this.Url = null;
        this.isPost = true;
    ...
    public DataHttpClient setUrl(String url) {
        this.Url = url;
     ...
     * @return
     */
    public DataHttpClient setResponseParse(ResponseParseData responseParse) {
     ...
     * @return
     */
    public DataHttpClient setTimeOut(int connetionTimeOut, int connectionRequestTimeout, int sockTimeOut) {
     ...
     * @return
     */
    public DataHttpClient setPost(boolean isPost) {
        this.isPost = isPost;
        return this;
    }
     ...
     * @return
     */
    public DataHttpClient setAjax(boolean isAjax) {
        this.isAjax = isAjax;
        return this;
    }
     ...
     * @return
     */
    public DataHttpClient setCharset(String charsetName) {
     ...
     */
    public DataHttpClient setParseFormat(String parseFormat) {
     ...
     * @return
     */
    public DataHttpClient setCookieInterface(HttpCookieInterface cookieInterface) {
     ...
     * @return
     */
    public DataHttpClient setCookieTag(String cookieTag) {
     ...
     * @return
     */
    public DataHttpClient setHttpCacheInterface(HttpCacheInterface httpCacheInterface) {
     ...
     * @return
     */
    public DataHttpClient setCacheTag(String cacheTag) {
     ...
     * @return
     */
    public DataHttpClient setForceMainLooper(boolean isForceMainLooper) {
     ...
     * @return
     */
    public DataHttpClient setReqeustHeaders(Map<String, String> reqeustHeaders) {
     ...
     * @return
     */
    public DataHttpClient setLogger(String loggerTag) {
     ...
     * @return
     */
    public DataHttpClient setLogger(HttpConfig.LoggerLevel loggerLevel) {
     ...
     * @return
     */
    public DataHttpClient setLogger(HttpConfig.LoggerLevel loggerLevel, String loggerTag) {
        if (null == loggerLevel) {
     ...
     * @return
     */
    public DataHttpClient setTryCallBack(boolean isTryCallBack) {
     ...
     * @return
     */
    public DataHttpClient setRequestBody(HttpEntity mHttpEntity) {
     ...
     * @return
     */
    public DataHttpClient setRequestBody(String postStr) {
        if (null == postStr) {
            return this;
        }
     ...
     * @return
     */
    public DataHttpClient setRequestBodyByCharset(String postStr, String bodyCharsetName) {
        if (null == postStr) {
            return this;
        }
     ...
     * @return
     */
    public DataHttpClient setRequestBodyByContentType(String postStr, String contentType) {
        if (null == postStr) {
            return this;
        }
     ...
     * @return
     */
    public DataHttpClient setRequestBody(HttpMultipartBuilder httpMultipartBuilder) {
     ...
     * @param responseData
     */
    private void parseHttpCallBackSucess(final byte[] responseData, int reponseCode, String respCharsetName,
                                         String respFormat) {
