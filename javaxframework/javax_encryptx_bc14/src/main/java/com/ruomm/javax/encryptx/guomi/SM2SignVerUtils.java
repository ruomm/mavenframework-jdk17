...
class SM2SignVerUtils {
    ...
    public static byte[] ToSm3MDByPrivateKey(byte[] privatekey, byte[] userIdData, byte[] sourceData) {
        ...
        if (SMConfig.isLog) {
            log.debug("ToSm3MDByPrivateKey->" + "椭圆曲线点X: " + userKey.getX().toBigInteger().toString(16));
            log.debug("ToSm3MDByPrivateKey->" + "椭圆曲线点Y: " + userKey.getY().toBigInteger().toString(16));
        }
    ...
    public static byte[] ToSm3MDByPrivateKeyStream(byte[] privatekey, byte[] userIdData, InputStream inputStream) {
        try {
            ...
            ECPoint userKey = factory.ecc_point_g.multiply(userD);
            if (SMConfig.isLog) {
                log.debug("ToSm3MDByPrivateKeyStream->" + "椭圆曲线点X: " + userKey.getX().toBigInteger().toString(16));
                log.debug("ToSm3MDByPrivateKeyStream->" + "椭圆曲线点Y: " + userKey.getY().toBigInteger().toString(16));
            }
    ...
    public static SM2SignVO Sign2SM2WithSM3(byte[] privatekey, byte[] sm3Md) {
        try {
            ...
            ECPoint userKey = factory.ecc_point_g.multiply(userD);
            if (SMConfig.isLog) {
                log.debug("Sign2SM2WithSM3->" + "椭圆曲线点X: " + userKey.getX().toBigInteger().toString(16));
                log.debug("Sign2SM2WithSM3->" + "椭圆曲线点Y: " + userKey.getY().toBigInteger().toString(16));
            }
    ...
    public static SM2SignVO Sign2SM2(byte[] privatekey, byte[] userIdData, byte[] sourceData) {
        try {
            ...
            ECPoint userKey = factory.ecc_point_g.multiply(userD);
            if (SMConfig.isLog) {
                log.debug("Sign2SM2->" + "椭圆曲线点X: " + userKey.getX().toBigInteger().toString(16));
                log.debug("Sign2SM2->" + "椭圆曲线点Y: " + userKey.getY().toBigInteger().toString(16));
            }
