...
public class SM2KeyHelper {
    ...
    public KeyPairStoreFormat generateKeyPairStoreFormat() {
        ...
        keyPairStoreFormat.setPublicKey(encoderHelper.encodeToString(sm2KeyVO.getPublicKey().getEncoded()));
...
//		System.arraycopy(ecP, 32, certPKY, 0, 32);
    ...
    public byte[] loadPrivateKey(String privatekeyStr) throws Exception {
        ...
        DEREncodable derEncodable1 = seq.getObjectAt(2);
        DEROctetString derOctetString1 = (DEROctetString) derEncodable1;
        DERSequence derSequence1 = (DERSequence) ASN1Sequence.fromByteArray(derOctetString1.getOctets());
        DEREncodable derEncodable2 = derSequence1.getObjectAt(1);
        DEROctetString derOctetString2 = (DEROctetString) derEncodable2.getDERObject();
