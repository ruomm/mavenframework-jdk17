...
//        try {
//            Charset charset = CharsetUtils.parseRealCharset(charsetName,Charset.forName("UTF-8"));
//            return verifySign(userId.getBytes(charset), sourceData.getBytes(charset), dataEncoderHelper.decode(signData),
...
//        try {
//            Charset charset = CharsetUtils.parseRealCharset(charsetName,Charset.forName("UTF-8"));
//            signResult = verifySignByInputStream(userId.getBytes(charset), inputStream, dataEncoderHelper.decode(signData),
