...
public final class Log {
     ...
     * @hide
     */
    public final static int LOG_ID_MAIN = 0;
    /**
     * @hide
     */
    public final static int LOG_ID_RADIO = 1;
    /**
     * @hide
     */
    public final static int LOG_ID_EVENTS = 2;
    /**
     * @hide
     */
    public final static int LOG_ID_SYSTEM = 3;
    /**
     * @hide
     */
    public final static int LOG_ID_CRASH = 4;
    ...
    public static int println(int bufID, int priority, String tag, String msg) {
        System.out.print("android日志->");
        System.out.println(bufID + ":" + priority + ":" + nullToEmpty(tag) + ":" + nullToEmpty(msg));
        return 0;
    }
